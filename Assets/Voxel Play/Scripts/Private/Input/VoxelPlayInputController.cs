...
namespace VoxelPlay {
	...
	public abstract class VoxelPlayInputController : MonoBehaviour {
		...
		public virtual bool GetKeyDown (string buttonName) {
			return false;
		}
		...
		protected virtual void ReadButtonState (InputButtonNames button, string buttonName) {
		...
		protected virtual void ReadKeyState (InputButtonNames button, KeyCode keyCode) {
