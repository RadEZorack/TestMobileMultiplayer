...
namespace VoxelPlay {
    ...
    public abstract class MeshingThread {
        ...
        public virtual void Init(int threadId, int poolSize, VoxelPlayEnvironment env) {
            ...
            this.allowAO = env.enableSmoothLighting;
        ...
        public void Clear() {
            ...
            if (greedyCollider != null) {
                greedyCollider.Clear();
                greedyCollider = null;
            }
            if (greedyNavMesh != null) {
                greedyNavMesh.Clear();
                greedyNavMesh = null;
            }
            ...
            if (tempChunkVertices != null) {
                tempChunkVertices.Clear();
                tempChunkVertices = null;
            }
            if (tempChunkUV0 != null) {
                tempChunkUV0.Clear();
                tempChunkUV0 = null;
            }
            if (tempChunkColors32 != null) {
                tempChunkColors32.Clear();
                tempChunkColors32 = null;
            }
            if (tempChunkNormals != null) {
                tempChunkNormals.Clear();
                tempChunkNormals = null;
            }
            if (meshColliderIndices != null) {
                meshColliderIndices.Clear();
                meshColliderIndices = null;
            }
            if (meshColliderVertices != null) {
                meshColliderVertices.Clear();
                meshColliderVertices = null;
            }
            if (navMeshIndices != null) {
                navMeshIndices.Clear();
                navMeshIndices = null;
            }
            if (navMeshVertices != null) {
