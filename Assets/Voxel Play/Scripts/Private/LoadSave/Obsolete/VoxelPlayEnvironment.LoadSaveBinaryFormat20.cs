...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        void LoadGameBinaryFileFormat_20 (BinaryReader br, bool singleFile, bool preservePlayerPosition = false, VoxelDefinition fallbackVoxelDefinition = null) {
            ...
            if (enableDynamicLoad && !singleFile && !string.IsNullOrEmpty(regionsIds)) {
                ...
                using (Stream extraStream = GetSaveGameStream("extra")) {
                    if (extraStream != null) {
                        using (BinaryReader brExtra = new BinaryReader(extraStream, Encoding.UTF8)) {
                            LoadGameExtraDataBinaryFormat_20(brExtra);
                        }
                    }
                }
            } else {
                ...
                if (singleFile) {
                    LoadGameRegionBinaryFormat_20(br);
                    LoadGameExtraDataBinaryFormat_20(br);
                } else {
                        ...
                        foreach (var regionId in regionIds) {
                            using (Stream regionStream = GetSaveGameStream(regionId)) {
                                ...
                                using (BinaryReader brRegion = new BinaryReader(regionStream, Encoding.UTF8)) {
                                    LoadGameRegionBinaryFormat_20(brRegion);
                                }
                            }
                        }
                    }
        ...
        void LoadGameRegionBinaryFormat_20 (BinaryReader br) {
        ...
        void LoadGameExtraDataBinaryFormat_20 (BinaryReader br) {
