...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        void LoadGameBinaryFileFormat_16 (BinaryReader br, bool singleFile, bool preservePlayerPosition = false) {
            ...
            if (singleFile) {
                ...
                LoadGameExtraDataBinaryFormat_16(br);
            } else {
                    ...
                    using (Stream extraStream = GetSaveGameStream("extra")) {
                        if (extraStream != null) {
                            using (BinaryReader brExtra = new BinaryReader(extraStream, Encoding.UTF8)) {
                                LoadGameExtraDataBinaryFormat_16(brExtra);
                            }
                        }
                    }
                }
        ...
        void LoadGameExtraDataBinaryFormat_16 (BinaryReader br) {
