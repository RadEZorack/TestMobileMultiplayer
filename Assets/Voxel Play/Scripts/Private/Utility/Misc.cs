...
namespace VoxelPlay {
    ...
    public static class Misc {
        ...
        public static Vector3 vector3minusHalf = new Vector3(-0.5f, -0.5f, -0.5f);
        ...
        public static void DestroyAndNullify<T>(ref T obj) where T : UnityEngine.Object {
            if (obj == null) return;
#if UNITY_EDITOR
            if (Application.isPlaying) {
                UnityEngine.Object.Destroy(obj);
        ...
        public static void DestroyImmediateAndNullify<T>(ref T obj) where T : UnityEngine.Object {
            if (obj == null) return;
            UnityEngine.Object.DestroyImmediate(obj);
            obj = null;
        }
