            ...
            for (int p = 0; p < MAX_ITERATIONS; p++) {
                for (int k = 0; k < count; k++) {
                    ...
                    while (worm.life > 0) {
                        ...
                        if (incy > 0) {
                            int maxWormAltitude = env.GetHeightMapInfoFast(worm.head.x, worm.head.z).groundLevel + depth;
                            if (worm.head.y >= maxWormAltitude) {
                                incy = -incy;
                            }
                        }
                        worm.head.y += incy;
                            ...
                            for (int y = miny; y < maxy; y++) {
                                ...
                                for (int z = minz; z < maxz; z++) {
                                    ...
                                    for (int x = minx; x < maxx; x++) {
                                        ...
                                        chunk.voxels[voxelIndex].typeIndex = Voxel.HOLE_TYPE_INDEX;
                                    }
                                }
                            }
                            worm.life--;
