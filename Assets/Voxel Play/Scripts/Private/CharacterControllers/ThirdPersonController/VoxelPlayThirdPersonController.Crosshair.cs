...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayThirdPersonController : VoxelPlayCharacterControllerBase {
        ...
        protected virtual void LateUpdateImpl() {
            ...
            if (env == null || !env.applicationIsPlaying || !enableCrosshair || input == null || crosshair == null)
                return;
            ...
            crosshairOnBlock = env.RayCast(ray, out hitInfo, 0, 0, colliderTypes: ColliderTypes.IgnorePlayer, layerMask: crosshairHitLayerMask, microVoxels: microVoxels > 0) && hitInfo.voxelIndex >= 0;
